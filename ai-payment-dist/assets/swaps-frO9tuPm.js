import{b7 as A,b8 as U,bq as _,bv as i,bw as D,bb as u,bf as V,bl as W,ba as $,bk as M,b9 as K,bj as L,bm as F,bg as Q,bo as q}from"./index-CuJCDeaq.js";import{r as s,n as w,c as C,U as x}from"./if-defined-BGIr1FyQ.js";import"./index-B_KWVbzS.js";import{M as R}from"./index-CCKzdXoq.js";import"./index-BEZ1RLOz.js";import"./index-Ic-wO_wz.js";import"./index-DlzXDZfM.js";import"./index-BBobMXDU.js";import"./index-NWPTFFjg.js";import"./index-Dm3WAqCi.js";import"./index-BqPBbBEv.js";const G={numericInputKeyDown(l,t,e){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",O=o===".",B=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&l.preventDefault(),t==="0"&&B&&(e(o),l.preventDefault()),(E||O)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!B&&!n.includes(o)&&!O&&!E&&l.preventDefault()}},H=A`
  :host {
    width: 100%;
  }
