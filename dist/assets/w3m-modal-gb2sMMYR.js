import{M as x,ay as ae,R as c,z as de,n as C,q as L,u as y,x as d,G as _,t as ue,v as D,C as g,K as j,au as he,J as V,E as U,O as R,I as F,w as pe,S as O,Z as z,T as me,az as fe,aA as we}from"./index-lHrz27V_.js";import{c as w,n as l,r as u,U as ne}from"./index-8xLacpUL.js";import{o as W}from"./if-defined-jnwmd0iL.js";import"./index-CHAD8A-u.js";import"./index-DyjG2McP.js";import{H as ee}from"./HelpersUtil-CviRdRKC.js";import"./index-BXoogP8p.js";import"./index-B89Wr0wk.js";import"./index-CkqiMJgb.js";import"./index-BffOsQsU.js";import{S as be}from"./SwapController-9BOyWbEm.js";import"./index-B75Zsb72.js";import"./index-BuAba9p5.js";import"./index-DUMl9uMo.js";import"./index-DtdMR0AG.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
