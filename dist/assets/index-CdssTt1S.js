import{n as d,q as m,t as c,u as f,v,x as h}from"./index-BZ66Af0Q.js";import{n as r,c as y,U as b}from"./index-BQLnFluk.js";import{e as g,n as w}from"./ref-Dl-AlaRr.js";const x=d`
  :host {
    position: relative;
...
`;var a=function(t,e,n,s){var p=arguments.length,o=p<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,n,s);else for(var l=t.length-1;l>=0;l--)(u=t[l])&&(o=(p<3?u(o):p>3?u(e,n,o):u(e,n))||o);return p>3&&o&&Object.defineProperty(e,n,o),o};let i=class extends f{constructor(){super(...arguments),this.inputElementRef=g(),this.disabled=!1,this.value="",this.placeholder="0",this.widthVariant="auto",this.maxDecimals=void 0,this.maxIntegers=void 0,this.fontSize="h4",this.error=!1}firstUpdated(){this.resizeInput()}updated(){this.style.setProperty("--local-font-size",v.textSize[this.fontSize]),this.resizeInput()}render(){var e;return this.dataset.widthVariant=this.widthVariant,this.dataset.error=String(this.error),(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),this.widthVariant==="auto"?this.inputTemplate():h`
