import{M as x,az as ae,R as c,z as de,n as C,q as L,u as y,x as d,G as _,t as ue,v as D,C as g,K as j,av as he,J as V,E as U,O as R,I as F,w as pe,S as O,Z as z,T as me,aA as fe,aB as we}from"./index-7q_FX4oS.js";import{c as w,n as l,r as u,U as ne}from"./index-B1tgjzNg.js";import{o as W}from"./if-defined-Bof84qkg.js";import"./index-BlaR1rfE.js";import"./index-Bv2HcdPQ.js";import{H as ee}from"./HelpersUtil-DF6QS2hN.js";import"./index-B6hul8lp.js";import"./index-D9eI_L-1.js";import"./index-DwVxj_wt.js";import"./index-CVw7tSUG.js";import{S as be}from"./SwapController-DUOnhENk.js";import"./index-BXWxCEpb.js";import"./index-D5fLi140.js";import"./index-Dlke8h43.js";import"./index-DwedNKSm.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
