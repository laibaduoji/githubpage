import{M as x,az as ae,R as c,z as de,n as C,q as L,u as y,x as d,G as _,t as ue,v as D,C as g,K as j,av as he,J as V,E as U,O as R,I as F,w as pe,S as O,Z as z,T as me,aA as fe,aB as we}from"./index-DysoNCc-.js";import{c as w,n as l,r as u,U as ne}from"./index-hfInzuWu.js";import{o as W}from"./if-defined-B0qKOnUb.js";import"./index-CeeQ--vh.js";import"./index-BJLTAOIf.js";import{H as ee}from"./HelpersUtil-B_OZ5zDg.js";import"./index-DiMrVAAp.js";import"./index-DUIx9AhU.js";import"./index-hN9uSxTu.js";import"./index-C3VKHk3c.js";import{S as be}from"./SwapController-eEzyTpzF.js";import"./index-400DqoRL.js";import"./index-bVbhd97r.js";import"./index-BR05Ipqp.js";import"./index-DMgy9_bM.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
