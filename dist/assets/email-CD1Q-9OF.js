import{C as S,z as g,O as h,E as c,M as _,R as s,S as f,d as C,n as D,u as y,I as d,x as m,w as $,Y as W,A as P}from"./index-7q_FX4oS.js";import{c as u,r as E}from"./index-B1tgjzNg.js";import{W as b}from"./index-DHGexWeS.js";import"./index-D9eI_L-1.js";import"./index-Dlke8h43.js";import{e as N,n as T}from"./ref-BjrQDGHs.js";import"./index-BXWxCEpb.js";import"./index-DHxmXpHg.js";import"./index-B6hul8lp.js";import"./if-defined-Bof84qkg.js";import"./index-CELxirP7.js";var F=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends b{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,r;try{if(this.authConnector){const n=S.state.activeChain,i=g.getConnections(n),o=(t=h.state.remoteFeatures)==null?void 0:t.multiWallet,l=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await g.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((r=h.state.remoteFeatures)!=null&&r.emailCapture)return;if(h.state.siwx){_.close();return}if(l&&o){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(n)}}),n}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([u("w3m-email-verify-otp-view")],I);const U=D`
  wui-icon-box {
