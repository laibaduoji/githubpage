import{M as x,az as ae,R as c,z as de,n as C,q as L,u as y,x as d,G as _,t as ue,v as D,C as g,K as j,av as he,J as V,E as U,O as R,I as F,w as pe,S as O,Z as z,T as me,aA as fe,aB as we}from"./index-7q1yxU0Y.js";import{c as w,n as l,r as u,U as ne}from"./index-DltqBpJT.js";import{o as W}from"./if-defined-BAzWpf8Y.js";import"./index-DXMgqFNo.js";import"./index-DbmeD7a1.js";import{H as ee}from"./HelpersUtil-Cu_T_uiL.js";import"./index-DRTf5BJS.js";import"./index-BbpF3dNh.js";import"./index-CDrSjENX.js";import"./index-pC3efYep.js";import{S as be}from"./SwapController-CPPIHziY.js";import"./index-wA_MydQi.js";import"./index-CobUCR8n.js";import"./index-Duh7TVq-.js";import"./index-D4HVgKXg.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
