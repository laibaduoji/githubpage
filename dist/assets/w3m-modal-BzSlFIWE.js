import{M as x,az as ae,R as c,z as de,n as C,q as L,u as y,x as d,G as _,t as ue,v as D,C as g,K as j,av as he,J as V,E as U,O as R,I as F,w as pe,S as O,Z as z,T as me,aA as fe,aB as we}from"./index-C6H5iNm2.js";import{c as w,n as l,r as u,U as ne}from"./index-Dk3hKmWE.js";import{o as W}from"./if-defined-Dds1bbeT.js";import"./index-LZFx0TG7.js";import"./index-UUc6L0Ii.js";import{H as ee}from"./HelpersUtil-B-v8CzSD.js";import"./index-B_yqyWRq.js";import"./index-CinoydPY.js";import"./index-B-JiIPEv.js";import"./index-8SDQRjiL.js";import{S as be}from"./SwapController-DQ4RdJ7Y.js";import"./index-Borc0Wcp.js";import"./index-DJqXtK41.js";import"./index-XYPJFu1f.js";import"./index-ClXsntxR.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
