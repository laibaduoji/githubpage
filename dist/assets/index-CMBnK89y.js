import{w as p,u,R as f,M as g,x as a}from"./index-CzaULBtk.js";import{n as b,r as w,c as m}from"./index-CvMj2ky6.js";import{T as l}from"./index-8mxLzFNO.js";const C={interpolate(r,e,t){if(r.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=r[0]||0,i=r[1]||0,o=e[0]||0,s=e[1]||0;return t<n?o:t>i?s:(s-o)/(i-n)*(t-n)+o}},M=p`
  :host {
    width: 100%;
    display: block;
  }
