import{M as x,az as ae,R as c,z as de,n as C,q as L,u as y,x as d,G as _,t as ue,v as D,C as g,K as j,av as he,J as V,E as U,O as R,I as F,w as pe,S as O,Z as z,T as me,aA as fe,aB as we}from"./index-wtjQWmv5.js";import{c as w,n as l,r as u,U as ne}from"./index-PKWqWarm.js";import{o as W}from"./if-defined-CHvxleaA.js";import"./index-nf_9550Q.js";import"./index-CSQGdoy5.js";import{H as ee}from"./HelpersUtil-mcsmdID1.js";import"./index-CPrZQjSi.js";import"./index-DJNalavA.js";import"./index-Iot1CUIu.js";import"./index-xYUKdf3F.js";import{S as be}from"./SwapController-92GR_rMU.js";import"./index-DOB93gL1.js";import"./index-B9gLn6bJ.js";import"./index-BVy4gfTo.js";import"./index-CzifvcNO.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
